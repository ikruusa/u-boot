...
/*
 * T-Head C906 custom CSR definitions for Allwinner D1
 */

#ifndef _ASM_RISCV_ARCH_THEAD_CSR_H
#define _ASM_RISCV_ARCH_THEAD_CSR_H
...
#endif /* _ASM_RISCV_ARCH_THEAD_CSR_H */
